...
const uint8_t charset[][5] PROGMEM = {
  ...
  { 0x00, 0x08, 0x38, 0x7c, 0xfe },  // 11 ltriangle
  { 0x24, 0x66, 0xff, 0x66, 0x24 },  // 12 varrow
  { 0x00, 0xbf, 0x00, 0xbf, 0x00 },  // 13 !!
  { 0x0e, 0xff, 0x01, 0xff, 0x01 },  // 14 enter sign
  { 0x00, 0xb8, 0xee, 0x3a, 0x00 },  // 15 paragraph
  { 0x18, 0x18, 0x18, 0x18, 0x18 },  // 16 fat stick
  { 0x24, 0x66, 0xff, 0x66, 0x24 },  // 17 varrow
  { 0x04, 0x06, 0xff, 0x06, 0x04 },  // 18 uarrow
  { 0x20, 0x60, 0xff, 0x60, 0x20 },  // 19 darrow
  { 0x10, 0x10, 0x7c, 0x38, 0x10 },  // 1a rarrow
  { 0x10, 0x38, 0x7c, 0x10, 0x10 },  // 1b larrow
